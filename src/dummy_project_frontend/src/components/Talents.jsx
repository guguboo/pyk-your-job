            ...
            <div id="jobs" className="w-full pt-[12rem]">
                <div className="w-[80rem] mx-auto flex flex-col">
                    ...
                    <div className="grid grid-cols-2 justify-center">
                        <div className="transition-opacity group flex flex-col px-[15%] py-[20%] m-[5%] ml-0 rounded-[3rem] border justify-between gap-24 font-semibold relative bg-no-repeat bg-cover hover:bg-[url('/img/talents/bg.png')]">
                        ...
                        <div className="transition-opacity group flex flex-col px-[15%] py-[20%] m-[5%] mr-0 rounded-[3rem] border justify-between gap-24 font-semibold relative bg-no-repeat bg-cover hover:bg-[url('/img/talents/bg.png')]">
