...
function Talents(){
    return(
            <div className="w-full mb-[5%]">
                <div className="w-[1500px] mx-auto flex flex-col">
                    <div className="text-5xl font-bold text-center">Pick Your Talents Now</div>
                    <div className="grid grid-cols-2 my-[5%] justify-center">
                        <div className="group flex flex-col px-[15%] py-[20%] m-[5%] ml-0 rounded-[3rem] border justify-between gap-24 font-semibold relative bg-no-repeat bg-cover hover:bg-[url('/img/talents/bg.png')]">
                        ...
                        <div className="group flex flex-col px-[15%] py-[20%] m-[5%] mr-0 rounded-[3rem] border justify-between gap-24 font-semibold relative bg-no-repeat bg-cover hover:bg-[url('/img/talents/bg.png')]">
